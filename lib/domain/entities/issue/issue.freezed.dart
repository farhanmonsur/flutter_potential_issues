...
class _$UserImpl implements _User {
  const _$UserImpl({required this.login});
...
abstract class _User implements User {
  const factory _User({required final String login}) = _$UserImpl;
...
class _$LabelImpl implements _Label {
  const _$LabelImpl({required this.name});
...
abstract class _Label implements Label {
  const factory _Label({required final String name}) = _$LabelImpl;
